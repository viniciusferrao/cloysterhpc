...
CPU::CPU(std::size_t sockets, std::size_t coresPerSocket, std::size_t threadsPerCore)
         : CPU(sockets,
               coresPerSocket * sockets,
               threadsPerCore * coresPerSocket * sockets,
               coresPerSocket,
               threadsPerCore) {}
...
size_t CPU::getThreads() const {
    return m_threads;
}

size_t CPU::getCoresPerSocket() const {
    return m_coresPerSocket;
}

size_t CPU::getThreadsPerCore() const {
