...
TEST_SUITE("Network class")
{
    TEST_CASE("Test Network setters and getters")
    {
        auto testNetwork = Network(Network::Profile::External);

        SUBCASE("Get m_profile")
        {
            CHECK(testNetwork.getProfile() == Network::Profile::External);
        }

        SUBCASE("Set and get m_address")
        {
        ...
        SUBCASE("Set and get m_subnetMask")
        {
        ...
        SUBCASE("Set and get m_vlan")
        {
            testNetwork.setVLAN(2000);
            CHECK(testNetwork.getVLAN() == 2000);
        }

        SUBCASE("Set and get m_domainName")
        {
