...
sdbus::MethodCall DBusClient::createMethodCall(std::string interface,
                                               std::string method) {
...
std::unique_ptr<MessageBusMethod> DBusClient::method(std::string interface,
                                                     std::string method) {
  auto m = this->createMethodCall(interface, method);
  std::unique_ptr<MessageBusMethod> mtd(new DBusMethod{this, std::move(m)});
  return mtd;
}
