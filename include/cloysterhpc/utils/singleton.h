...
constexpr auto os()
{
    return cloyster::Singleton<models::Cluster>::get()->getHeadnode().getOS();
}
constexpr auto osservice()
{
    return cloyster::Singleton<const services::IOSService>::get();
}
constexpr auto options()
{
    return cloyster::Singleton<const services::Options>::get();
}
constexpr auto answerfile()
{
    return cloyster::Singleton<const models::AnswerFile>::get();
}
...
{
    return cloyster::Singleton<services::IRunner>::get();
}
constexpr auto repos()
{
    return cloyster::Singleton<services::repos::RepoManager>::get();
}
