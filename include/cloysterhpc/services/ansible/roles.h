 ...
 * @param osinfo The OS metadata to determine compatibility and platform-specific behavior.
 * @return ScriptBuilder A builder object containing the installation script for the given role.
 *
...
/**
 * @brief Executes the installation script for a given Ansible role if the condition matches.
 *
