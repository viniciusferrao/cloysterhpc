...
const repofile RPMFusion
    = { "rpmfusion-free-updates", true, "rpmfusion-free-updates",
          "https://mirror.versatushpc.com.br/rpmfusion/free/el/", "", true,
          "file:///etc/pki/rpm-gpg/RPM-GPG-KEY-rpmfusion-free-el-8",
          R"PGPKEY(-----BEGIN PGP PUBLIC KEY BLOCK-----
